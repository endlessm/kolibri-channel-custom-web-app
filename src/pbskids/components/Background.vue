...
<script>
import * as PIXI from '@/pbskids/pixi';
import { gsap } from 'gsap';

import textureImage from '@/pbskids/components/sprites/textures.png';
import textureInfo from '@/pbskids/components/sprites/textures.json';
import displacementImage from '@/pbskids/components/sprites/displacement.png';
